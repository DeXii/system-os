...
- Опирайся на foundation.setLogsSummary, foundation.bftHistory, foundation.trainingSessionsLast14d — не выдумывай метрики.
...
Используй integration.ops7d, integration.synergy, integration.stages (4 этапа: foundation, regulation, mind, influence — НЕ 3 уровня PDF), compliance.trend7d, stageProgress.
...
Используй regulation.hrvTrend14d, regulation.hrvBaseline14d, regulation.breathing7d, regulation.readinessRegulation, regulation.readinessFoundation.
...
Используй mind.ops7d, mind.chessTrend30d, mind.cognitiveThrottle, mind.readingProgress, readiness.
